...
public class PostsRepositoryTest {
    ...
    // Junit에서 단위 테스트가 끝날 때마다 수행되는 메소드를 지정.(테스트간 데이터 침범을 막기위함).
    ...
    public void BaseTimeEntity_등록(){
        //given
        LocalDateTime now = LocalDateTime.of(2022,10,17,0,0,0);
        ...
        //then
        Posts posts=postsList.get(0);
        // Posts extend BaseTimeEntity 이기 때문에 BaseTimeEntity의 메소드를 사용할 수 있는 것.
